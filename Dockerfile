...
RUN chown lsadm:lsadm -R /usr/local/lsws/conf && \
    ...
    # INSTALL SHARED LIBS
RUN apt-get install -y lsphp82 lsphp82-apcu lsphp82-apcu-dbgsym lsphp82-common lsphp82-curl lsphp82-dbg lsphp82-dev lsphp82-igbinary lsphp82-igbinary-dbgsym lsphp82-imagick lsphp82-imagick-dbgsym lsphp82-imap lsphp82-intl lsphp82-ldap lsphp82-memcached lsphp82-memcached-dbgsym lsphp82-modules-source lsphp82-msgpack lsphp82-msgpack-dbgsym lsphp82-mysql lsphp82-opcache lsphp82-pgsql lsphp82-pspell lsphp82-snmp lsphp82-sqlite3 lsphp82-sybase lsphp82-tidy && \
    apt-get autoclean -y

COPY ./php.d/max-file-upload.ini /usr/local/lsws/lsphp82/etc/php/8.2/mods-available/max-file-upload.ini
COPY ./php.d/mem-limit.ini /usr/local/lsws/lsphp82/etc/php/8.2/mods-available/mem-limit.ini
...
COPY ./php.d/20-redis.ini /usr/local/lsws/lsphp82/etc/php/8.2/mods-available/20-redis.ini
...
COPY ./php.d/20-excimer.ini /usr/local/lsws/lsphp82/etc/php/8.2/mods-available/20-excimer.ini
